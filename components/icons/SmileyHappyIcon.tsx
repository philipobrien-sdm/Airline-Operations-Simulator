...
interface SmileyHappyIconProps {
  className?: string;
  title?: string;
}

const SmileyHappyIcon: React.FC<SmileyHappyIconProps> = ({ className, title }) => {
  return (
    <svg 
